<template>
    ...
    >
        <div class="encyption-passphrase">
            <div class="encyption-passphrase__header">Enable encryption</div>
            <div class="encyption-passphrase__body">
                <div class="encyption-passphrase__body__text">
                    Enter passphrase that will be used to encrypt your content.
                </div>
                <div
...
export default class EncryptionPassphraseModal extends Vue {
    ...
    async handleEnter(close: () => void) {
        ...
        const encryptedPrivateKeys = this.$encryption.encryptUserPrivateKeys(
            privateKeys,
            hkdf,
        );
        ...
        await this.$serviceRegistry.invoke(
            ...
            DatabaseServiceAction.UNLOCK_PRIVATE_KEYS,
            {
                ...
                callerContext: 'EnableEncryptionModal.vue unlock private keys',
            },
        );
        ...
        this.$vfm.show({
            component: () =>
                import('@/components/modal/CreateRecoveryKeyModal.vue'),
        });
