...
<script>
export default {
    name: 'ComputerDesktopHelpAlternate',
    props: {
        size: {
            type: String,
            required: false,
