...
<script>
export default {
    name: 'ComputerDesktopMusicAlternate',
    props: {
        size: {
            type: String,
            required: false,
