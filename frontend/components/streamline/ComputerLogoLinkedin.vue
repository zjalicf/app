<template>
    ...
    >
        <g>
            <path
                d="M2.34,4.46H1.87a1.26,1.26,0,0,0-1,.22.92.92,0,0,0-.23.71V13.1a.91.91,0,0,0,.23.7.91.91,0,0,0,.68.2c.22,0,.41,0,.82,0a1.19,1.19,0,0,0,.93-.19,1,1,0,0,0,.23-.7V5.39a.92.92,0,0,0-.24-.71C3.08,4.44,2.74,4.45,2.34,4.46Z"
            />
            <path
                d="M2.1,0A1.62,1.62,0,0,0,.51,1.56,1.65,1.65,0,0,0,2.1,3.19,1.62,1.62,0,0,0,3.7,1.56,1.62,1.62,0,0,0,2.1,0Z"
            />
            <path
