<template>
    ...
    >
        <g>
            <path
                d="M2.44,8.38a.24.24,0,0,0,0-.28A4.94,4.94,0,0,1,2,6,.75.75,0,0,0,.5,6a6.43,6.43,0,0,0,.78,3.08.26.26,0,0,0,.18.13.29.29,0,0,0,.22-.07Z"
            />
            <path
                d="M9.44,1.37a.25.25,0,0,0,.08-.18A.23.23,0,0,0,9.44,1,3.44,3.44,0,0,0,7,0,3.5,3.5,0,0,0,3.5,3.5V6a3.1,3.1,0,0,0,.08.69.27.27,0,0,0,.17.19A.25.25,0,0,0,4,6.81Z"
            />
            <path
