...
<script>
export default {
    name: 'EntertainmentMusicNoteOff2',
    props: {
        size: {
            type: String,
            required: false,
