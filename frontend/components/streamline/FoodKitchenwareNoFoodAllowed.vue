<template>
    ...
    >
        <g>
            <path
                d="M13.85,3.53a.26.26,0,0,0-.25.05L10,7.23a.08.08,0,0,0,0,.09.12.12,0,0,0,.07.07v5.86a.75.75,0,0,0,1.5,0V7.57a.25.25,0,0,1,.17-.23A3.72,3.72,0,0,0,14,3.75.24.24,0,0,0,13.85,3.53Z"
            />
            <path
...
<script>
export default {
    name: 'FoodKitchenwareNoFoodAllowed',
    props: {
        size: {
            type: String,
            required: false,
