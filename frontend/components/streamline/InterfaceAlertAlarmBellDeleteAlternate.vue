...
<script>
export default {
    name: 'InterfaceAlertAlarmBellDeleteAlternate',
    props: {
        size: {
            type: String,
            required: false,
