...
<script>
export default {
    name: 'InterfaceAlertAlarmBellRemoveAlternate',
    props: {
        size: {
            type: String,
            required: false,
