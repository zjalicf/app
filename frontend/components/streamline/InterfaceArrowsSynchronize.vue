...
<script>
export default {
    name: 'InterfaceArrowsSynchronize',
    props: {
        size: {
            type: String,
            required: false,
