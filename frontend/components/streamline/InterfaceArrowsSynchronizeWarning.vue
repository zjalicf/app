...
<script>
export default {
    name: 'InterfaceArrowsSynchronizeWarning',
    props: {
        size: {
            type: String,
            required: false,
