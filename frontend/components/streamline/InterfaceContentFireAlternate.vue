...
<script>
export default {
    name: 'InterfaceContentFireAlternate',
    props: {
        size: {
            type: String,
            required: false,
