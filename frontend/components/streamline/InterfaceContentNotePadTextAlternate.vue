...
<script>
export default {
    name: 'InterfaceContentNotePadTextAlternate',
    props: {
        size: {
            type: String,
            required: false,
