<template>
    ...
    >
        <g>
            <path
                d="M1,14a1,1,0,0,0,.71-.29l1.86-1.87a.26.26,0,0,1,.35,0l1.87,1.87a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.42L5.34,10.43a.24.24,0,0,1,0-.35L7.2,8.21a1,1,0,0,0,0-1.41,1,1,0,0,0-.71-.29,1,1,0,0,0-.7.29L3.92,8.66a.24.24,0,0,1-.35,0L1.71,6.8A1,1,0,0,0,1,6.51a1,1,0,0,0-.71.29,1,1,0,0,0,0,1.41l1.87,1.87a.26.26,0,0,1,0,.35L.29,12.29a1,1,0,0,0,0,1.42A1,1,0,0,0,1,14Z"
            />
            <path
...
<script>
export default {
    name: 'InterfaceFileDeleteAlternate',
    props: {
        size: {
            type: String,
            required: false,
