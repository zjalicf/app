...
<script>
export default {
    name: 'InterfaceShareMegaPhoneSetting1',
    props: {
        size: {
            type: String,
            required: false,
