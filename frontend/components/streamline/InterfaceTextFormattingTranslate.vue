...
<script>
export default {
    name: 'InterfaceTextFormattingTranslate',
    props: {
        size: {
            type: String,
            required: false,
