<template>
    ...
    >
        <g>
            <path
                d="M4.82,6.82a.23.23,0,0,0,0,.21.25.25,0,0,0,.19.09H6a.24.24,0,0,0,.24-.19l.17-.75a.23.23,0,0,0,0-.21.25.25,0,0,0-.19-.09h-1A.24.24,0,0,0,5,6.07Z"
            />
            <path
...
<script>
export default {
    name: 'MailChatBubbleCensorSquare',
    props: {
        size: {
            type: String,
            required: false,
