...
<script>
export default {
    name: 'MoneyCashBriefcaseDollarAlternate',
    props: {
        size: {
            type: String,
            required: false,
