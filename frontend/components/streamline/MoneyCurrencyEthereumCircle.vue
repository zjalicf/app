<template>
    ...
    >
        <g>
            <path
                d="M8.23,5.8a.23.23,0,0,0,.1-.17.28.28,0,0,0-.06-.18L7.19,4.15a.25.25,0,0,0-.38,0L5.73,5.45a.28.28,0,0,0-.06.18.23.23,0,0,0,.1.17l1.07.86a.24.24,0,0,0,.32,0Z"
            />
            <path
...
<script>
export default {
    name: 'MoneyCurrencyEthereumCircle',
    props: {
        size: {
            type: String,
            required: false,
