...
<script>
export default {
    name: 'NatureEcologyGlobalWarming1',
    props: {
        size: {
            type: String,
            required: false,
