...
<script>
export default {
    name: 'NatureEcologyLeafProtectAlternate',
    props: {
        size: {
            type: String,
            required: false,
