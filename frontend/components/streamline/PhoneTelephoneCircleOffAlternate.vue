...
<script>
export default {
    name: 'PhoneTelephoneCircleOffAlternate',
    props: {
        size: {
            type: String,
            required: false,
