...
<script>
export default {
    name: 'ProgrammingBugVirusBrowser',
    props: {
        size: {
            type: String,
            required: false,
