...
<script>
export default {
    name: 'ProgrammingBugVirusFolderAlternate',
    props: {
        size: {
            type: String,
            required: false,
