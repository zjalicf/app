...
<script>
export default {
    name: 'ProgrammingBugVirusMonitor',
    props: {
        size: {
            type: String,
            required: false,
