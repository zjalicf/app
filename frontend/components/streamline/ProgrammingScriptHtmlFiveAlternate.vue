...
<script>
export default {
    name: 'ProgrammingScriptHtmlFiveAlternate',
    props: {
        size: {
            type: String,
            required: false,
