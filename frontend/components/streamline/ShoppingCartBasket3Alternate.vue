...
<script>
export default {
    name: 'ShoppingCartBasket3Alternate',
    props: {
        size: {
            type: String,
            required: false,
