...
<script>
export default {
    name: 'ShoppingClothAccessoriesConstructionHelmet2',
    props: {
        size: {
            type: String,
            required: false,
