...
<script>
export default {
    name: 'ShoppingStoreFactorySetting',
    props: {
        size: {
            type: String,
            required: false,
