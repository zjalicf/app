<template>
    ...
    >
        <g>
            ...
            />
            <path
                d="M7.38,10.5H5.5A.75.75,0,0,1,5.5,9H7.38a.38.38,0,0,0,0-.75H5.5a.76.76,0,0,1-.75-.75V5.25A.76.76,0,0,1,5.5,4.5h3A.75.75,0,0,1,8.5,6h-2a.25.25,0,0,0-.25.25V6.5a.25.25,0,0,0,.25.25h.88a1.88,1.88,0,0,1,0,3.75Z"
            />
        </g>
    </svg>
</template>
<script>
export default {
    name: 'TravelHotelFiveStarAlternate',
    props: {
        size: {
            type: String,
            required: false,
