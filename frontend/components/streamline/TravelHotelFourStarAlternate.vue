<template>
    ...
    >
        <g>
            <path
                d="M8.5,4.75a.76.76,0,0,0-.75.75v1a.25.25,0,0,1-.25.25h-1a.25.25,0,0,1-.25-.25v-1a.75.75,0,0,0-1.5,0v2a.76.76,0,0,0,.75.75h2a.25.25,0,0,1,.25.25v1a.75.75,0,0,0,1.5,0v-4A.76.76,0,0,0,8.5,4.75Z"
            />
            <path
...
<script>
export default {
    name: 'TravelHotelFourStarAlternate',
    props: {
        size: {
            type: String,
            required: false,
