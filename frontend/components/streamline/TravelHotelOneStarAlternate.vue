<template>
    ...
    >
        <g>
            <path
                d="M9.25,9.5a.76.76,0,0,0-.75-.75H8a.25.25,0,0,1-.25-.25v-3A.76.76,0,0,0,7,4.75H5.75a.75.75,0,0,0,0,1.5H6a.25.25,0,0,1,.25.25v2A.25.25,0,0,1,6,8.75H5.5a.75.75,0,0,0,0,1.5h3A.76.76,0,0,0,9.25,9.5Z"
            />
            <path
...
<script>
export default {
    name: 'TravelHotelOneStarAlternate',
    props: {
        size: {
            type: String,
            required: false,
