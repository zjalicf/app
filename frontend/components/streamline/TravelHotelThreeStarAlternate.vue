...
<script>
export default {
    name: 'TravelHotelThreeStarAlternate',
    props: {
        size: {
            type: String,
            required: false,
