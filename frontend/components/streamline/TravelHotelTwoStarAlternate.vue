...
<script>
export default {
    name: 'TravelHotelTwoStarAlternate',
    props: {
        size: {
            type: String,
            required: false,
