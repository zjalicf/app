...
<script>
export default {
    name: 'TravelMapNavigationArrowOffAlternate',
    props: {
        size: {
            type: String,
            required: false,
