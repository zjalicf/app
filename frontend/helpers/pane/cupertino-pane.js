...
class Events {
    ...
    attachAllEvents() {
        ...
        if (this.settings.topperOverflow) {
            this.instance.overflowEl.addEventListener(
                'scroll',
                this.onScrollCb,
            );
        }
    ...
    detachAllEvents() {
        ...
        // scroll events for overflowEl
        if (this.settings.topperOverflow) {
            this.instance.overflowEl.removeEventListener(
                'scroll',
                this.onScrollCb,
            );
        }
    ...
    touchMove(t) {
        ...
        // Event emitter
        t.delta =
            ((_a = this.steps[0]) === null || _a === void 0
                ? void 0
                : _a.posY) - clientY;
        ...
        if (
            ...
            let differKoef =
                ...
                -8;
            newVal =
                this.instance.getPanelTransformY() + diffY * (0.5 - differKoef);
            let mousePointY =
                (clientY - 220 - this.instance.screen_height) * -1;
            if (
                mousePointY <=
    ...
    touchEnd(t) {
        ...
        if (this.fastSwipeNext('Y')) {
            closest = this.instance.swipeNextPoint(
                ((_a = this.steps[this.steps.length - 1]) === null ||
                _a === void 0
                    ? void 0
                    : _a.posY) -
                    ((_b = this.steps[this.steps.length - 2]) === null ||
                    _b === void 0
                        ? void 0
                        : _b.posY), //diff
    ...
    onKeyboardShow(e) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // calculate distances
            const currentHeight =
                this.settings.breaks[this.breakpoints.prevBreakpoint].height;
            ...
            const offset =
                this.device.cordova && this.device.android ? 150 : 100;
            let spaceBelowOffset = 0;
            let newHeight =
                currentHeight + (e.keyboardHeight - inputSpaceBelow);
            // Multiple event fired with opened keyboard
            if (this.prevNewHeight) {
                spaceBelowOffset =
                    this.previousInputBottomOffset - inputElBottomBound;
    ...
    fastSwipeNext(axis) {
        var _a, _b;
        const diff =
            ((_a = this.steps[this.steps.length - 1]) === null || _a === void 0
                ? void 0
                : _a['pos' + axis]) -
            ((_b = this.steps[this.steps.length - 2]) === null || _b === void 0
                ? void 0
                : _b['pos' + axis]);
    ...
    handleTopperLowerPositions(coords) {
        ...
        if (
            ...
            const differKoef =
                ...
                8;
            return (
                this.instance.getPanelTransformY() + coords.diffY * differKoef
            );
        }
    ...
    getEventClientYX(ev, name) {
        ...
        const distanceY = Math.abs(
            clientY -
                (((_b = this.steps[this.steps.length - 1]) === null ||
                _b === void 0
                    ? void 0
                    : _b.posY) || 0),
        );
    ...
    buildBreakpoints(conf, bottomOffset = 0, animated = true) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            ['top', 'middle', 'bottom'].forEach(val => {
                ...
                if (
                    (_a = this.settings.breaks[val]) === null || _a === void 0
                        ? void 0
                        : _a.enabled
                ) {
                    this.breaks[val] =
            ...
            if (!this.instance.isPanePresented()) {
                this.currentBreakpoint =
                    this.breaks[this.settings.initialBreak];
            }
            if (this.instance.isPanePresented()) {
                // Move to current if updated
                if (
                    (_a = this.settings.breaks[this.prevBreakpoint]) === null ||
                    _a === void 0
                        ? void 0
                        : _a.enabled
                ) {
                ...
                if (
                    !((_b = this.settings.breaks[this.prevBreakpoint]) ===
                        null || _b === void 0
                        ? void 0
                        : _b.enabled)
                ) {
...
class Transitions {
        ...
        return new Promise(resolve =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (params.type === CupertinoTransition.Move) {
                    ...
                    this.instance.paneEl.style.transition =
                        'all 0ms linear 0ms';
                ...
                if (
                    ...
                    ).find(val => val[1] === params.translateY);
                    let bounce =
                        nextBreak &&
                        ((_b = this.settings.breaks[nextBreak[0]]) === null ||
                        _b === void 0
                            ? void 0
                            : _b.bounce);
                    // transition style
                    ...
                    this.instance.paneEl.style.setProperty(
                        'transition',
                        buildedTransition,
                    );
                    // Main transitions
                    ...
                    let getNextBreakpoint = Object.entries(
                        this.breakpoints.breaks,
                    ).find(val => val[1] === params.translateY);
                    if (getNextBreakpoint) {
                        this.breakpoints.prevBreakpoint = getNextBreakpoint[0];
                    }
                    this.instance.paneEl.addEventListener(
                        'transitionend',
                        transitionEnd,
                    );
                }
    ...
    buildTransitionValue(bounce, duration) {
        ...
        return `all ${duration || this.settings.animationDuration}ms ${
...
function emit(...args) {
    ...
    eventsArray.forEach(event => {
        var _a;
        if (
            (_a = this.eventsListeners) === null || _a === void 0
                ? void 0
                : _a[event]
        ) {
...
class ZStackModule {
    ...
    setZstackConfig(zStack) {
        ...
        this.settings.zStack = zStack
            ? Object.assign(Object.assign({}, this.zStackDefaults), zStack)
            : null;
    }
    /**
    ...
    pushTransition(pushElement, newPaneY, transition) {
        ...
        const setStyles = (scale, y, contrast, border) => {
            ...
            pushElement.style.transform = `translateY(${
                y * (exponentAngle / scale)
            }px) scale(${scale})`;
    ...
    clearPushMultiplicators() {
        for (let i = 0; i < this.settings.zStack.pushElements.length; i++) {
            let pushElement = document.querySelector(
...
class FollowerModule {
    constructor(instance) {
        ...
        this.instance.on('rendered', () => {
            ...
            this.followerEl.style.transition =
                this.transitions.buildTransitionValue(
                    (_a =
                        this.settings.breaks[this.instance.currentBreak()]) ===
                        null || _a === void 0
                        ? void 0
                        : _a.bounce,
                );
      ...
      `);
        ...
        if (Support.touch) {
            ...
            this.instance.on('onDidPresent', () => {
                var _a;
                (_a = this.backdropEl) === null || _a === void 0
                    ? void 0
                    : _a.addEventListener(
    ...
    backdrop(conf = { show: true }) {
        ...
        if (!this.isBackdropPresented()) {
            ...
            if (Support.touch) {
                ...
                (_b = this.backdropEl) === null || _b === void 0
                    ? void 0
                    : _b.addEventListener(
                          this.events.touchEvents.move,
                          this.touchMoveBackdropCb,
...
class FitHeightModule {
        ...
        this.instance.on(
            ...
            ev => {
                ...
                if (this.settings.fitScreenHeight) {
                    if (
                        ((_a = this.settings.breaks[ev.break]) === null ||
                        _a === void 0
                            ? void 0
                            : _a.height) > this.instance.screen_height
                    ) {
    ...
    beforeBuildBreakpoints() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.breakpoints.conf.top.bounce =
                (_b =
                    (_a = this.settings.breaks) === null || _a === void 0
                        ? void 0
                        : _a.top) === null || _b === void 0
                    ? void 0
                    : _b.bounce;
            this.breakpoints.conf.bottom = ((_c = this.settings.breaks) ===
                null || _c === void 0
                ? void 0
                : _c.bottom) || { enabled: true, height: 0 };
        });
    }
    calcFitHeight(animated = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.breakpoints.buildBreakpoints(
...
class InverseModule {
    constructor(instance) {
        ...
        this.events['handleTopperLowerPositions'] = coords =>
            this.handleTopperLowerPositions(coords);
      ...
      `);
        ...
        this.instance.on('buildBreakpointsCompleted', () => {
            ...
            this.instance.paneEl.style.top = `-${
    ...
    prepareBreaksSwipeNextPoint() {
        ...
        settingsBreaks['top'] = Object.assign(
            {},
            this.settings.breaks['bottom'],
        );
        settingsBreaks['middle'] = Object.assign(
            {},
            this.settings.breaks['middle'],
        );
        settingsBreaks['bottom'] = Object.assign(
            {},
            this.settings.breaks['top'],
        );
...
class HorizontalModule {
    ...
    setPaneElTransform(params) {
        ...
        this.instance.paneEl.style.transform = `translateX(${
            closest || 0
        }px) translateY(${params.translateY}px) translateZ(0px)`;
    }
    getClosestBreakX() {
...
class CupertinoPane {
    constructor(selector, conf = {}) {
        ...
        modules.forEach(
            module =>
                (this.modules[this.getModuleRef(module.name)] = new module(
                    this,
                )),
        );
    }
    drawBaseElements() {
        ...
        this.styleEl.id = `cupertino-pane-${(Math.random() + 1)
            .toString(36)
            .substring(7)}`;
        // Parent
            ...
            Object.assign(
                ...
                (_a =
                    conf === null || conf === void 0
                        ? void 0
                        : conf.transition) === null || _a === void 0
                    ? void 0
                    : _a.from,
            );
            // Show elements
    ...
    isPanePresented() {
        ...
        return wrappers.find(item => item.contains(this.selector))
            ? true
            : false;
    }
    prepareBreaksSwipeNextPoint() {
    ...
    moveToHeight(val) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let translateY = this.screenHeightOffset
