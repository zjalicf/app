    ...
    <div class="success-page">
        <div class="success-page--container">
            <div class="success-page--container--content">
                <img src="/integrations/github.png" alt="acreom logo" />
            </div>
            <div class="success-page--container--title">
                Github account authorised. Return to acreom to finish
                integration.
            </div>
...
@Component({
    ...
    layout: 'homepage',
    asyncData(route) {
        const { access_token, state } = route.query;
...
export default class GitHub extends Vue {
    ...
    get authString() {
        return `github&${this.access_token}&${this.state}`;
    }
