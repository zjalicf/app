// Type definitions for dexie-syncable v3.0.0-beta.10
...
export interface SyncableEventSet extends DexieEventSet {
    (
        ...
        subscriber: (status: number, url: string) => void,
    ): void;
}
...
declare module 'dexie' {
    interface Dexie {
        ...
        _uncommittedChanges: Dexie.Table<
            IDatabaseChange & { id: number; node: number },
            number
        >;
    }
    ...
    interface DexieConstructor {
        Syncable: {
            ...
            registerSyncProtocol: (
                name: string,
                prototocolInstance: ISyncProtocol,
            ) => void;

            unregisterSyncProtocol: (name: string) => void;
